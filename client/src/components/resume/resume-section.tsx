...
import { PlusIcon } from "lucide-react"; // Assuming you're using Lucide icons

interface ResumeSectionProps {
    resumes: any[];
    onCreateCV: () => void; // Function to handle CV creation
}

const ResumeSection: React.FC<ResumeSectionProps> = ({ resumes, onCreateCV }) => {
    return (
        <div id="resume-section" className="container mx-auto p-4 mt-8">
            ...
            {resumes.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center p-6 bg-gray-100 border border-gray-300 rounded-lg">
                    ...
                    <Button onClick={onCreateCV} className="bg-primary text-white hover:bg-primary-dark">
